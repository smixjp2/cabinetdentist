        ...
        <div className="grid gap-6">
            ...
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>
                    ID Patient: DENTI-{patient.id.padStart(4, '0')}
                  </CardDescription>
                </div>
              </div>
              <div className="flex gap-2 ml-auto">
                ...
                />
                <Button>
                  <CalendarIcon className="mr-2 h-4 w-4" /> Nouveau RDV
                </Button>
              </div>
            </CardHeader>
          ...
          <Tabs defaultValue="chart">
            ...
            <TabsContent value="info">
              <Card>
                <CardHeader>
                  <CardTitle>Informations et notes</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    {patient.medicalHistory.length > 0 ? (
                      <div className="flex gap-2 mt-1">
                        {patient.medicalHistory.map((history) => (
                          <Badge key={history} variant="secondary">
                            {history}
                          </Badge>
                        ))}
                      </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground italic p-3 bg-muted rounded-md mt-1">
            ...
            <TabsContent value="chart">
              <Card>
                <CardHeader>
                  <CardTitle>Schéma dentaire interactif</CardTitle>
                </CardHeader>
                <CardContent>
                  <DentalChart />
                </CardContent>
            ...
            <TabsContent value="history">
              <Card>
                <CardHeader>
                  <CardTitle>Historique des soins</CardTitle>
                </CardHeader>
                <CardContent>
